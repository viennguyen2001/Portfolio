...
```bash
git clone https://github.com/viennguyen2001/viennguyencong.id.vn
```

or use a starter template:

```bash
npx create-next-app -e https://github.com/viennguyen2001/viennguyencong.id.vn your-app-name
```

```bash
npx degit viennguyencong/viennguyencong.id.vn your-app-name
```

Or deploy directly:

[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/viennguyencong/viennguyencong.id.vn)  
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/viennguyencong/viennguyencong.id.vn)
...
🧠 Made with curiosity, love, and caffeine ☕ by [Vien Nguyen Cong](https://viennguyencong.id.vn)
